...
public class Descargar extends AsyncTask<String, Integer, Estado> {
    ...
    public Descargar(Context context,TextView estado,Button descargar,ProgressBar progress,RadioButton rdbcambio) {
        this.context      = context;
        this.lblEstado    = estado;
        this.btnDescargar = descargar;
        this.Progress = progress;
        this.rdbCambio = rdbcambio;
    }
    ...
    protected Estado doInBackground(String... sUrl) {
        ...
        try {
            ...
            if(rdbCambio.isChecked()){
                nombre=sUrl[1].toString() +".jpg";
